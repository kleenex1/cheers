...
urlpatterns = [
    ...
    # 레시피
    path('recipe-user', views.RecipeMainView.as_view(), name='recipe-user'),
    ...
    path('main-recipe/', TemplateView.as_view(template_name="main/main_recipe.html"), name="main-recipe"),
    path('main-recipe-detail/', TemplateView.as_view(template_name="main/main_recipe_detail.html"), name="main-recipe-detail"),
